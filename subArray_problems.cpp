...
// Consider the array 1, -2, -3, 4. When we are at the second element, our runningProduct becomes -2. 
...
//To accomodate for this, we can have two running products: maxProd and minProd. maxProd will track the maximum product that we can achieve 
//and will reset whenever the current number is greater, just as above. minProd, on the other hand, 
//will track the minimum product that we can achieve and will reset whenever the current number is smaller. 
